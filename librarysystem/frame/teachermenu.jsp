...
<body>
	<div id="jquery-accordion-menu" class="jquery-accordion-menu">
		...
		<ul>
			<li class="active"><a href="${pageContext.request.contextPath}/admin/listAll"  target="response"><!-- <i class="fa fa-home"></i> -->查看所有书籍
			</a></li>
			<li><a href="${pageContext.request.contextPath}/teacher/addbook.jsp"  target="response"><!-- <i class="fa fa-file-image-o"> --></i>添加书籍 </a></li>
			<li><a href="${pageContext.request.contextPath}/teacher/addcategory.jsp"  target="response"><!-- <i class="fa fa-cog"></i> -->添加分类 </a></li>
