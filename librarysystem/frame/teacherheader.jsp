...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-21" data-genuitec-path="/librarysystem/WebRoot/frame/teacherheader.jsp">
    	<hr size="5px" color="lightblue" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-21" data-genuitec-path="/librarysystem/WebRoot/frame/teacherheader.jsp"/>
	<h1>后台管理<!--  <span style="text-align:right;float:right">
